...
- [ExecuteQuery](/templates/protocols/javascript/modules/mssql.MSSQLClient#executequery)
...
▸ **ConnectWithDB**(`ctx`, `host`, `port`, `username`): `boolean`
...
▸ **ExecuteQuery**(`ctx`, `host`, `port`, `username`): [`SQLResult`](/templates/protocols/javascript/modules/mssql.SQLResult)
