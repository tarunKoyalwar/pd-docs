...
▸ **Connect**(`ctx`, `host`, `port`, `username`): `boolean`
...
▸ **ConnectWithDSN**(`ctx`, `dsn`): `boolean`
...
▸ **ExecuteQuery**(`ctx`, `host`, `port`, `username`): [`SQLResult`](/templates/protocols/javascript/modules/mysql.SQLResult)
...
▸ **ExecuteQueryOnDB**(`ctx`, `host`, `port`, `username`): [`SQLResult`](/templates/protocols/javascript/modules/mysql.SQLResult)
...
▸ **ExecuteQueryWithOpts**(`ctx`, `opts`, `query`): [`SQLResult`](/templates/protocols/javascript/modules/mysql.SQLResult)
...
▸ **FingerprintMySQL**(`ctx`, `host`, `port`): [`MySQLInfo`](/templates/protocols/javascript/modules/mysql.MySQLInfo)
