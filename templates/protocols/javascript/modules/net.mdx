...
▸ **Open**(`ctx`, `protocol`): [`NetConn`](/templates/protocols/javascript/modules/net.NetConn) \| ``null``
...
▸ **OpenTLS**(`ctx`, `protocol`): [`NetConn`](/templates/protocols/javascript/modules/net.NetConn) \| ``null``
